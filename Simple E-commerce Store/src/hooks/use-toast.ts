...
export const reducer = (state: State, action: Action): State => {
  // Always ensure we're working with a valid array
...
// Initialize with a valid empty array
...
function useToast() {
  ...
  return {
    // Always return a safe array even if something went wrong
    toasts: Array.isArray(memoryState?.toasts) ? memoryState.toasts : [],
    toast,
